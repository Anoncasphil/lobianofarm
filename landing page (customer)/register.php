...
?>
    ...
    <!-- inside the form -->
        <form action="register.php" autocomplete="off" method="post" class="flex flex-col justify-center items-center w-full h-[80%]">
            <h2 id="login_tag" class="text-3xl mb-5 font-bold">Create an Account</h2>
            <p id="input_tag" class="tracking-wide text-base">Create a account to continue</p>
            ...
            <!-- username -->
            <div id="username_container" class="flex flex-col justify-start items-start w-[80%] px-6 mt-5">
                <div class="relative flex flex-row justify-between w-full">
                    <label for="username_input" class="text-left w-[50%] mb-2">
                        Username:
                    </label>
                </div>
                <div class="relative w-full">
                    <i class="fa-solid fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    <input type="text" id="username_input" name="username" placeholder="Enter your Username:" 
                           class="w-full border border-gray-500 rounded-lg p-2 pl-10" minLength="3" required>
                </div>
            </div>

            <!-- First Name-->

            <div id="firstname_container" class="flex flex-col justify-start items-start w-[80%] px-6 mt-5">
                <div class="relative flex flex-row justify-between w-full">
                ...
                <div class="relative w-full">
                    <i class="fa-solid fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    <input type="text" id="firstname_input" name="firstname" placeholder="Enter your First Name:" 
                           class="w-full border border-gray-500 rounded-lg p-2 pl-10" minLength="3">
                </div>
            </div>
            <!-- Middle Name -->
            <div id="middlename_container" class="flex flex-col justify-start items-start w-[80%] px-6 mt-5">
                <div class="relative flex flex-row justify-between w-full">
                    <label for="middlename_input" class="text-left w-[50%] mb-2">
                        Middle Name:
                    </label>
                </div>
                <div class="relative w-full">
                    <i class="fa-solid fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    <input type="text" id="middlename_input" name="middlename" placeholder="Enter your Middle Name:" 
                           class="w-full border border-gray-500 rounded-lg p-2 pl-10" minLength="3">
                </div>
            </div>
            <!-- Last Name -->
            <div id="lastname_container" class="flex flex-col justify-start items-start w-[80%] px-6 mt-5">
                <div class="relative flex flex-row justify-between w-full">
                ...
                <div class="relative w-full">
                    <i class="fa-solid fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    <input type="text" id="lastname_input" name="lastname" placeholder="Enter your Last Name:" 
                           class="w-full border border-gray-500 rounded-lg p-2 pl-10" minLength="3">
                </div>
            </div>

            <!-- Contact No. -->
            <div id="contact_container" class="flex flex-col justify-start items-start w-[80%] px-6 mt-5">
                <div class="relative flex flex-row justify-between w-full">
                ...
                <div class="relative w-full">
                    <i class="fa-solid fa-user absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    <input type="text" id="contact_input" name="contactno" placeholder="Enter your Contact No:" 
            ...
            <!-- submit button -->
            <button type="submit" name="regisme"class="text-white w-[50%] h-[10%] mt-[10%] bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign Up</button>
            <p>Have an account already? <span><a href="login.php" class="underline text-blue-600 hover:underline">Login</a></span></p>
