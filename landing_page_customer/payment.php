...
<div class="flex flex-col justify-center items-center mt-5">
  ...
  <span id="code" class="text-xl font-bold text-blue-900 mt-2"></span>
</div>
...
<div class="flex flex-col justify-center items-center mt-5">
  <span id="downpayment" class="text-xl font-bold text-blue-900">₱0.00</span>
...
<div class="flex items-center justify-center w-full mt-5">
  ...
  <div class="mt-6 flex justify-center">
    <button type="button" onclick="submitReservation()" id="submitButton" class="bg-blue-900 text-white font-bold py-3 w-80 px-6 rounded-md shadow-lg hover:bg-blue-700 transition duration-200">
    Submit
    </button>
</div>
