...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="../addons/addons.php" class="active"><i class='bx bxs-widget icon' ></i> Add-ons</a></li>
    ...
    <div id="add-addon-modal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center">
			<div class="relative p-4 w-full max-w-md max-h-full">
				...
				<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
					...
					<!-- Modal body -->
					<form class="p-4 md:p-5" action="add-addons.php" method="POST" enctype="multipart/form-data">
